...
This is the quantum Monte Carlo code that I wrote to simulate the models in the paper [*Quantum Monte Carlo and Stabilizer States*](https://arxiv.org/abs/2408.09978). 

### Quantum Monte Carlo programs
SSE.cpp simulates the CNOT model and SSE_TFI.cpp simulates the Transverse-Field Ising (TFI) model.
